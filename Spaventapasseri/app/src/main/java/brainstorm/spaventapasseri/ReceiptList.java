...
public class ReceiptList extends AppCompatActivity {
    ...
    class PhotosAdapter extends RecyclerView.Adapter<PhotosAdapter.PhotoCardHolder> {
        ...
        public class PhotoCardHolder extends RecyclerView.ViewHolder {
            //public TextView title;
            public ImageView thumbnail;//, dotsMenu;

            public PhotoCardHolder(View view) {
                super(view);
